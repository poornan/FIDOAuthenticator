...
import org.wso2.carbon.identity.fido.u2f.stub.FIDOServiceStub;
...
public class FIDOClient {
	...
	public String getDeviceRegistration(String username, String appID) throws Exception {
		try {
			return stub.getDeviceRegistration(username, appID);
		} catch (RemoteException e) {
			String msg = "Cannot trigger getDeviceRegistration"
			             + " . Backend service may be unavailable";
			throw new Exception(msg, e);
		}
	}
